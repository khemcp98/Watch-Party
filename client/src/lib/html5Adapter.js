...
// { play, pause, seekTo, getCurrentTime, isReady } that UnifiedPlayer expects,
// regardless of whether the underlying source is a direct file or Drive link.
export function useHtml5Adapter() {
  ...
  return { videoRef, play, pause, seekTo, getCurrentTime, isReady };
}
